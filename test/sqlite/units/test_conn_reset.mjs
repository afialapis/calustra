...
test(`[sqlite][conn_reset] Test conn resets and so`, async function(t) {
  let conn
  
  t.test(`[sqlite][conn_reset] should init and cache the conn`, async function() {
  ...
  t.test(`[sqlite][conn_reset] should reset the conn`, async function() {
    conn = await calustra_sqlite_conn_init({
      reset: true
    })      
    assert.strictEqual(conn.isOpen, true)
  ...
  t.test(`[sqlite][conn_reset] should drop all conns`, async function() {
  ...
  t.test(`[sqlite][conn_reset] should drop this connection`, async function() {
